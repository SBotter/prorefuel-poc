...
export default function PhoneMockup() {
  ...
  const shellStyle = useMemo(() => ({
    ...
    padding: "10px",
    boxShadow:
      "0 0 0 1px rgba(255,255,255,0.08), 0 20px 60px rgba(0,0,0,0.95), inset 0 0 0 1px rgba(255,255,255,0.04)",
  }), []);
  ...
  return (
    <div className="relative w-full">
      {/* Phone shell */}
      <div className="relative rounded-[2.8rem] overflow-hidden" style={shellStyle}>
        {/* Side buttons */}
        ...
        <div className="relative rounded-[2.2rem] overflow-hidden bg-black" style={{ aspectRatio: "9/16" }}>
          ...
          <div
            ...
            style={{ width: "80px", height: "24px", willChange: "transform" }}
          />
